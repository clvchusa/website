...
const MENU_SEED = {
  kitchen: [
    { name: "Prime Smash Burger", desc: "Double patty, American cheese, house sauce, brioche bun", price: "$18", tag: "House favorite" },
    { name: "Bourbon Ribeye", desc: "14 oz wood-fired, compound butter, truffle jus, crispy shallots", price: "$54", tag: "" },
    { name: "Hot Honey Wings", desc: "12 piece, signature glaze, blue cheese, celery", price: "$22", tag: "House favorite" },
    { name: "Gulf Oysters", desc: "Half dozen, champagne mignonette, cocktail sauce, lemon", price: "$26", tag: "Seasonal" },
    { name: "Truffle Fries", desc: "Hand-cut, black truffle oil, parmesan, rosemary", price: "$14", tag: "" },
    { name: "Cauliflower Steak", desc: "Wood-roasted, romesco, pickled peppers, almonds", price: "$24", tag: "Veg" },
    { name: "Smash Sliders (4)", desc: "Mini smash patties, pickles, onion, special sauce", price: "$28", tag: "Shareable" },
    { name: "Shrimp & Grits", desc: "Gulf shrimp, stone-ground grits, andouille, tomato broth", price: "$32", tag: "Southern" },
  ],
  brunch: [
    { name: "Gold Room French Toast", desc: "Brioche, gold dust crumble, maple butter, fresh berries", price: "$19", tag: "Brunch" },
    { name: "Southern Fried Chicken & Waffles", desc: "Buttermilk fried chicken, Belgian waffle, hot honey, coleslaw", price: "$24", tag: "Brunch" },
    { name: "Avocado & Smoked Salmon Toast", desc: "Sourdough, everything seasoning, pickled onion, capers", price: "$22", tag: "Brunch" },
    { name: "Brunch Burger", desc: "Prime patty, fried egg, cheddar, house aioli, fries", price: "$22", tag: "Brunch" },
    { name: "Bottomless Mimosas", desc: "Sparkling wine, fresh-squeezed OJ · 90 minute window", price: "$28 / person", tag: "Bottomless" },
    { name: "Bottomless Bloody Marys", desc: "House mix, vodka, house-pickled garnishes · 90 minute window", price: "$28 / person", tag: "Bottomless" },
  ],
  bar: [
    { name: "Gold Rush Old Fashioned", desc: "Bourbon, demerara, Angostura, orange peel", price: "$18", tag: "Signature" },
    { name: "Smoked Margarita", desc: "Mezcal, lime, agave, smoked salt rim", price: "$17", tag: "Signature" },
    { name: "Midnight Mojito", desc: "White rum, activated charcoal mint syrup, lime, soda", price: "$16", tag: "" },
    { name: "Espresso Martini", desc: "Vodka, fresh espresso, coffee liqueur, vanilla foam", price: "$16", tag: "" },
    { name: "Ginger Mule (N/A option)", desc: "House ginger syrup, lime, soda — with vodka or without", price: "$12 / $14", tag: "N/A option" },
    { name: "Gold Room Bottle Service", desc: "Starting from · Table minimum applies", price: "From $250", tag: "VIP" },
  ],
};
